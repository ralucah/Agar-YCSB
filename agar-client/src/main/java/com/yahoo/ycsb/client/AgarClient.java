...
public class AgarClient extends ClientBlueprint {
    public static Logger logger = Logger.getLogger(AgarClient.class);
    ...
    public void init() throws ClientException {
        logger.debug("AgarClient.init() start");
        ...
        logger.debug("AgarClient.init() end");
    }
